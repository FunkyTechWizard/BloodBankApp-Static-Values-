...
public class DonorSchedulingActivity extends AppCompatActivity {
    DrawerLayout drawerLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.donorschedulingactivity);
        ...
        menuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Create a PopupMenu
                PopupMenu popupMenu = new PopupMenu(DonorSchedulingActivity.this, v);
